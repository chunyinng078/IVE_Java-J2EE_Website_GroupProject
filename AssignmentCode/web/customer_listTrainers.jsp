    ...
    <center style="background-color: #FBEEC1; top:  0; min-height:85vh" >
        ...
        <form method="get" action="customerHandleRecord">
            <div style="font-size:30px">
                ...
                Enter name: <input type="text" placeholder="Enter here" style="font-size:30px" name="name" /><br><br>
                Enter Keyword:
                <input type="text" placeholder="use , to separate keywords!" style="font-size:30px" name="keyword" />
                <br><br>
                Selection:
...
//                        }
        ...
        <%
            ...
            if ("listTrainers".equals(action)) {
                ...
                out.println("<tr>");
                out.println("<th>Trainer Name</th><th>States</th><th>Hour Rate</th><th>Description</th><th>SportType</th><th>Image</th><th>Booking</th>");
                out.println("</tr>");
                ...
                for (int i = 0; i < trainers.size(); i++) {
                    ...
                    out.println("<td><a href='customer_sendRequest.jsp?type=trainer&id=" + t.getId() + "'><button>Booking</button></a></td>");
                    out.println("</tr>");
                ...
                out.println("<table border='1'>");
                out.println("<tr>");
                out.println("<th>Gym Center Name</th><th>States</th><th>Hour Rate</th><th>Description</th><th>Image</th><th>Booking</th>");
                out.println("</tr>");
                // loop through the customer array to display each customer record
                for (int i = 0; i < gym.size(); i++) {
                    ...
                    out.println("<td><a href='customer_sendRequest.jsp?type=trainer&id=" + g.getId() + "'><button>Booking</button></a></td>");
                    out.println("</tr>");
